...
3. Finally, when the component is removed (*unmounted*), any cleanup that we need to perform like unsubscriptions are performed in the `componentWillUnmount` method.

## `useEffect` to the rescue :sparkles:
